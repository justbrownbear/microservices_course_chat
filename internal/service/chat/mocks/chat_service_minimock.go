...
//go:generate minimock -i github.com/justbrownbear/microservices_course_chat/internal/service/chat.ChatService -o chat_service_minimock.go -n ChatServiceMock -p mocks
