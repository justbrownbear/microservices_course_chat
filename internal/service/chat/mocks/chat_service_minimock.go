...
package chat_service_mock

//go:generate minimock -i github.com/justbrownbear/microservices_course_chat/internal/service/chat.ChatService -o chat_service_minimock.go -n ChatServiceMock -p chat_service_mock
...
import (
	...
	mm_chat_service "github.com/justbrownbear/microservices_course_chat/internal/service/chat"
)

// ChatServiceMock implements chat_service.ChatService
type ChatServiceMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcCreateChat          func(ctx context.Context, in *mm_chat_service.CreateChatRequest) (u1 uint64, err error)
	inspectFuncCreateChat   func(ctx context.Context, in *mm_chat_service.CreateChatRequest)
	...
	funcSendMessage          func(ctx context.Context, in *mm_chat_service.SendMessageRequest) (err error)
	inspectFuncSendMessage   func(ctx context.Context, in *mm_chat_service.SendMessageRequest)
	afterSendMessageCounter  uint64
	beforeSendMessageCounter uint64
	SendMessageMock          mChatServiceMockSendMessage
}

// NewChatServiceMock returns a mock for chat_service.ChatService
...
type ChatServiceMockCreateChatParams struct {
	ctx context.Context
	in  *mm_chat_service.CreateChatRequest
}
...
func (mmCreateChat *mChatServiceMockCreateChat) Expect(ctx context.Context, in *mm_chat_service.CreateChatRequest) *mChatServiceMockCreateChat {
...
func (mmCreateChat *mChatServiceMockCreateChat) ExpectInParam2(in *mm_chat_service.CreateChatRequest) *mChatServiceMockCreateChat {
	if mmCreateChat.mock.funcCreateChat != nil {
		mmCreateChat.mock.t.Fatalf("ChatServiceMock.CreateChat mock is already set by Set")
	}
...
func (mmCreateChat *mChatServiceMockCreateChat) Inspect(f func(ctx context.Context, in *mm_chat_service.CreateChatRequest)) *mChatServiceMockCreateChat {
...
func (mmCreateChat *mChatServiceMockCreateChat) Return(u1 uint64, err error) *ChatServiceMock {
	if mmCreateChat.mock.funcCreateChat != nil {
		mmCreateChat.mock.t.Fatalf("ChatServiceMock.CreateChat mock is already set by Set")
	}
...
func (mmCreateChat *mChatServiceMockCreateChat) Set(f func(ctx context.Context, in *mm_chat_service.CreateChatRequest) (u1 uint64, err error)) *ChatServiceMock {
	if mmCreateChat.defaultExpectation != nil {
...
// Then helper
func (mmCreateChat *mChatServiceMockCreateChat) When(ctx context.Context, in *mm_chat_service.CreateChatRequest) *ChatServiceMockCreateChatExpectation {
	if mmCreateChat.mock.funcCreateChat != nil {
		mmCreateChat.mock.t.Fatalf("ChatServiceMock.CreateChat mock is already set by Set")
	}
...
func (e *ChatServiceMockCreateChatExpectation) Then(u1 uint64, err error) *ChatServiceMock {
...
// CreateChat implements chat_service.ChatService
func (mmCreateChat *ChatServiceMock) CreateChat(ctx context.Context, in *mm_chat_service.CreateChatRequest) (u1 uint64, err error) {
...
func (mmDeleteChat *mChatServiceMockDeleteChat) Expect(ctx context.Context, chatID uint64) *mChatServiceMockDeleteChat {
...
func (mmDeleteChat *mChatServiceMockDeleteChat) ExpectChatIDParam2(chatID uint64) *mChatServiceMockDeleteChat {
	if mmDeleteChat.mock.funcDeleteChat != nil {
		mmDeleteChat.mock.t.Fatalf("ChatServiceMock.DeleteChat mock is already set by Set")
	}
...
func (mmDeleteChat *mChatServiceMockDeleteChat) Inspect(f func(ctx context.Context, chatID uint64)) *mChatServiceMockDeleteChat {
...
func (mmDeleteChat *mChatServiceMockDeleteChat) Set(f func(ctx context.Context, chatID uint64) (err error)) *ChatServiceMock {
	if mmDeleteChat.defaultExpectation != nil {
...
// Then helper
func (mmDeleteChat *mChatServiceMockDeleteChat) When(ctx context.Context, chatID uint64) *ChatServiceMockDeleteChatExpectation {
	if mmDeleteChat.mock.funcDeleteChat != nil {
		mmDeleteChat.mock.t.Fatalf("ChatServiceMock.DeleteChat mock is already set by Set")
	}
...
// DeleteChat implements chat_service.ChatService
func (mmDeleteChat *ChatServiceMock) DeleteChat(ctx context.Context, chatID uint64) (err error) {
	...
	if mmDeleteChat.DeleteChatMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.chatID != nil && !minimock.Equal(*mm_want_ptrs.chatID, mm_got.chatID) {
				mmDeleteChat.t.Errorf("ChatServiceMock.DeleteChat got unexpected parameter chatID, want: %#v, got: %#v%s\n", *mm_want_ptrs.chatID, mm_got.chatID, minimock.Diff(*mm_want_ptrs.chatID, mm_got.chatID))
			}
...
type ChatServiceMockSendMessageParams struct {
	ctx context.Context
	in  *mm_chat_service.SendMessageRequest
}
...
func (mmSendMessage *mChatServiceMockSendMessage) Expect(ctx context.Context, in *mm_chat_service.SendMessageRequest) *mChatServiceMockSendMessage {
...
func (mmSendMessage *mChatServiceMockSendMessage) ExpectInParam2(in *mm_chat_service.SendMessageRequest) *mChatServiceMockSendMessage {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ChatServiceMock.SendMessage mock is already set by Set")
	}
...
func (mmSendMessage *mChatServiceMockSendMessage) Inspect(f func(ctx context.Context, in *mm_chat_service.SendMessageRequest)) *mChatServiceMockSendMessage {
...
func (mmSendMessage *mChatServiceMockSendMessage) Set(f func(ctx context.Context, in *mm_chat_service.SendMessageRequest) (err error)) *ChatServiceMock {
	if mmSendMessage.defaultExpectation != nil {
...
// Then helper
func (mmSendMessage *mChatServiceMockSendMessage) When(ctx context.Context, in *mm_chat_service.SendMessageRequest) *ChatServiceMockSendMessageExpectation {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ChatServiceMock.SendMessage mock is already set by Set")
	}
...
// SendMessage implements chat_service.ChatService
func (mmSendMessage *ChatServiceMock) SendMessage(ctx context.Context, in *mm_chat_service.SendMessageRequest) (err error) {
	...
	if mmSendMessage.SendMessageMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.in != nil && !minimock.Equal(*mm_want_ptrs.in, mm_got.in) {
				mmSendMessage.t.Errorf("ChatServiceMock.SendMessage got unexpected parameter in, want: %#v, got: %#v%s\n", *mm_want_ptrs.in, mm_got.in, minimock.Diff(*mm_want_ptrs.in, mm_got.in))
			}
